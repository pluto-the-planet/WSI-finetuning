...
from utils.polynomial.divide_conquer import divide_and_conquer
from utils.polynomial.multiplication import Multiplication
from utils.polynomial.grad import d_logS_d_expX
